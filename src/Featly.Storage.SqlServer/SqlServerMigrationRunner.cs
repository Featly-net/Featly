...
/// <summary>
/// Snapshot of the SQL Server schema migration state: which migrations the
...
/// <summary>
/// Public, offline entry point for operating the Featly SQL Server schema
/// without a running host — the surface the <c>featly db</c> CLI commands sit
/// on top of. Mirrors <c>Featly.Storage.Postgres.PostgresMigrationRunner</c>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Every method takes a SQL Server <c>connectionString</c> and an optional
...
/// </para>
/// </remarks>
public static class SqlServerMigrationRunner
{
    /// <summary>
    ...
    public static async Task<SqlServerMigrationStatus> GetStatusAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new SqlServerMigrationStatus(status.Applied, status.Pending);
    }
