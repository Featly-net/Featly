...
/// <summary>
/// Snapshot of the MySQL schema migration state: which migrations the
...
/// </param>
public sealed record MySqlMigrationStatus(
    IReadOnlyList<string> Applied,
    IReadOnlyList<string> Pending);

/// <summary>
/// Public, offline entry point for operating the Featly MySQL schema without
/// a running host — the surface the <c>featly db</c> CLI commands sit on top
/// of. Mirrors <c>Featly.Storage.SqlServer.SqlServerMigrationRunner</c>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Every method takes a MySQL <c>connectionString</c> and an optional
...
/// </para>
/// </remarks>
public static class MySqlMigrationRunner
{
    /// <summary>
    ...
    public static async Task<MySqlMigrationStatus> GetStatusAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new MySqlMigrationStatus(status.Applied, status.Pending);
    }
