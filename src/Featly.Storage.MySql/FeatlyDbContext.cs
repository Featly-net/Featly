...
/// </summary>
/// <remarks>
/// This is PR 1 of the MySQL provider (issue #276): <see cref="Project"/>,
/// <see cref="Environment"/>, and <see cref="Flag"/> only, mirroring how the
/// Postgres (#157) and SQL Server (#274) providers' PR 1 started. The
/// remaining entities, the <c>MySqlFeatlyStore</c> facade, and
