...
internal sealed class EventConfiguration : IEntityTypeConfiguration<Event>
{
    ...
    public void Configure(EntityTypeBuilder<Event> builder)
    {
        ...
        // Arbitrary properties (revenue, plan, etc.) stored in a native MySQL
        // json column. A value comparer keeps EF's change tracking happy for
        // the dictionary, same pattern as JsonCollectionConversion.
