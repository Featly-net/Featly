...
internal sealed class ConfigConfiguration : IEntityTypeConfiguration<Config>
{
    public void Configure(EntityTypeBuilder<Config> builder)
    {
        ...
        // DefaultValue is a JsonElement — store as raw JSON text and parse on
        // read, same pattern as Variant.Value / Condition.Value.
        ...
        // Primitive collection serialised as a jsonb column, same as Flag.Tags.
        builder.PrimitiveCollection(c => c.Tags);

        // Targeting rules persisted as owned jsonb: each rule carries its
