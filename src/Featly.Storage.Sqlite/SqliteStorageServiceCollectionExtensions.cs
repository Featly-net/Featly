...
public static class SqliteStorageServiceCollectionExtensions
{
        ...
        Action<SqliteFeatlyStoreOptions>? configure = null)
    {
        ...
        services.TryAddSingleton<IUserStore, SqliteUserStore>();
        ...
        services.TryAddSingleton<IPendingChangeStore, SqlitePendingChangeStore>();
        services.TryAddSingleton<IApprovalPolicyStore, SqliteApprovalPolicyStore>();
