...
/// <summary>
/// Round-trip coverage for <c>PostgresConfigStore</c>, mirroring
/// <c>SqliteConfigStoreTests</c>. <c>Config.Rules</c> is an owned collection
/// persisted as <c>jsonb</c>, and <c>DefaultValue</c>/rule <c>Value</c> are
/// raw-JSON-text-mapped <c>JsonElement</c>s — this proves both hold across
/// every supported <see cref="ConfigType"/>.
/// </summary>
[Trait("Category", "RequiresPostgres")]
public class PostgresConfigStoreTests
{
    [Fact]
