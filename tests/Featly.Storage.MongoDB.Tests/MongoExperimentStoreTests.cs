...
/// <c>MySqlExperimentStoreTests</c>: <c>MongoExperimentStore</c> (with the
/// MetricKeys list and nullable started/stopped window), the append-only
/// <c>MongoEventStore</c> (with a JsonElement properties bag), and the
/// first-write-wins <c>MongoAssignmentStore</c>.
/// </summary>
[Trait("Category", "RequiresMongoDB")]
public class MongoExperimentStoreTests
{
    [Fact]
