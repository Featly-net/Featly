...
/// <summary>
/// Round-trip coverage for <c>MongoFlagStore</c>, mirroring
/// <c>MySqlFlagStoreTests</c>/<c>SqlServerFlagStoreTests</c>. Rules/variants
/// are embedded documents, native to Mongo's document model — no JSON-column
/// fallback needed here, unlike the MySQL provider.
/// </summary>
