...
/// <summary>
/// Round-trips for <c>MongoUserGroupStore</c>. <c>MemberUserIds</c> is a
/// native BSON array here, unlike the relational providers' JSON-column
/// fallback (ADR-0033) — <c>ListForMemberAsync</c> filters server-side via
/// <c>Builders&lt;T&gt;.Filter.AnyEq</c>, not an in-memory scan.
/// </summary>
[Trait("Category", "RequiresMongoDB")]
public class MongoUserGroupStoreTests
{
    [Fact]
