...
/// <summary>
/// Round-trip coverage for <c>MongoProjectStore</c>, mirroring
/// <c>MySqlProjectStoreTests</c>/<c>SqlServerProjectStoreTests</c>. Runs
/// against a real, throwaway MongoDB database per test (see
/// <see cref="MongoTestHost"/>) — requires a local single-node replica set or
/// <c>FEATLY_MONGODB_TEST_CONNECTION_STRING</c>.
/// </summary>
[Trait("Category", "RequiresMongoDB")]
public class MongoProjectStoreTests
{
    [Fact]
