...
/// <summary>
/// Round-trip coverage for <c>SqlServerFlagStore</c>, mirroring
/// <c>PostgresFlagStoreTests</c>. The rules/variants round-trip is the
/// highest-risk part of the SQL Server mapping: <c>Flag.Variants</c>/
/// <c>Flag.Rules</c> are owned collections persisted as JSON in an
/// <c>nvarchar(max)</c> column (vs. Postgres's native <c>jsonb</c>) — this
/// proves the mapping holds for nested conditions, weighted splits, and a
/// boolean JsonElement value.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerFlagStoreTests
{
    [Fact]
