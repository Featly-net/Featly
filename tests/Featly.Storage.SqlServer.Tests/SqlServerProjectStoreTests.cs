...
/// <summary>
/// Round-trip coverage for <c>SqlServerProjectStore</c>, mirroring
/// <c>PostgresProjectStoreTests</c>. Runs against a real, throwaway SQL Server
/// database per test (see <see cref="SqlServerTestHost"/>) — requires
/// <c>FEATLY_SQLSERVER_TEST_*</c> env vars or a local SQL Server on 1433.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerProjectStoreTests
{
    [Fact]
