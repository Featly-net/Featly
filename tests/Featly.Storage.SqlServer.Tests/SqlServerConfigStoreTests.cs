...
/// <summary>
/// Round-trip coverage for <c>SqlServerConfigStore</c>, mirroring
/// <c>PostgresConfigStoreTests</c>. <c>Config.Rules</c> is an owned collection
/// persisted as JSON, and <c>DefaultValue</c>/rule <c>Value</c> are
/// raw-JSON-text-mapped <c>JsonElement</c>s — this proves both hold across
/// every supported <see cref="ConfigType"/>.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerConfigStoreTests
{
    [Fact]
