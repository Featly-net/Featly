...
/// <c>PostgresExperimentStoreTests</c>: <c>SqlServerExperimentStore</c> (with
/// the MetricKeys JSON array and nullable started/stopped window), the
/// append-only <c>SqlServerEventStore</c> (with a JsonElement properties
/// bag), and the first-write-wins <c>SqlServerAssignmentStore</c>.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerExperimentStoreTests
{
    [Fact]
