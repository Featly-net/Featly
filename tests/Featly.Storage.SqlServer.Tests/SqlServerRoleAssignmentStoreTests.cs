...
/// <summary>
/// Round-trips for <c>SqlServerRoleAssignmentStore</c>, mirroring
/// <c>PostgresRoleAssignmentStoreTests</c>. Assignments are the polymorphic
/// join (user/group → role) scoped to a project and optionally an environment.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerRoleAssignmentStoreTests
{
    [Fact]
