...
/// <summary>
/// Persistence + lookup behaviour of <c>SqlServerApiKeyStore</c>, mirroring
/// <c>PostgresApiKeyStoreTests</c>. The store holds only Argon2 hashes — these
/// tests poke at the row shape and the indexed prefix lookup the auth
/// pipeline calls on every request.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerApiKeyStoreTests
{
    [Fact]
