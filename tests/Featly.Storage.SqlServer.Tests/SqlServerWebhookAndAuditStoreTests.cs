...
/// <c>PostgresWebhookAndAuditStoreTests</c>: <c>SqlServerWebhookStore</c>
/// (with the subscribed event-types collection), the persisted
/// <c>SqlServerWebhookDeliveryStore</c> queue (due claim + result update),
/// and the append-only <c>SqlServerAuditStore</c> log (filtered query with a
/// JsonElement payload).
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerWebhookAndAuditStoreTests
{
    [Fact]
