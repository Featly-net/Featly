...
/// <summary>
/// Round-trips for <c>SqlServerPendingChangeStore</c> (with owned
/// approvals + comments and JsonElement proposed/current state) and
/// <c>SqlServerApprovalPolicyStore</c> (with owned approver rules, one per
/// environment), mirroring <c>PostgresApprovalStoreTests</c>.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerApprovalStoreTests
{
    [Fact]
