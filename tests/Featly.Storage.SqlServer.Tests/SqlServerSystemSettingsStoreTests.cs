...
/// <summary>
/// Round-trips for <c>SqlServerSystemSettingsStore</c>, mirroring
/// <c>PostgresSystemSettingsStoreTests</c>: a typed-singleton row keyed by
/// aggregate key, with a JSON payload and audit stamps. Upsert is
/// replace-in-place by key.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerSystemSettingsStoreTests
{
