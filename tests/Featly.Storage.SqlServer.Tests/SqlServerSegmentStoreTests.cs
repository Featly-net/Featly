...
/// <summary>
/// Round-trip coverage for <c>SqlServerSegmentStore</c>, mirroring
/// <c>PostgresSegmentStoreTests</c>. <c>Segment.Conditions</c> is an owned
/// collection persisted as JSON in an <c>nvarchar(max)</c> column — this
/// proves the mapping holds for nested condition operators (Equals, In) and
/// array values.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerSegmentStoreTests
{
