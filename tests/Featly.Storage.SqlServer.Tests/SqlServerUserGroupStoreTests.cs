...
/// <summary>
/// Round-trips for <c>SqlServerUserGroupStore</c>, mirroring
/// <c>PostgresUserGroupStoreTests</c>. Membership is stored as a JSON array
/// (vs. Postgres's native <c>uuid[]</c>); <c>ListForMemberAsync</c> is the
/// lookup the permission checker uses to expand a user into its groups, so
/// the JSON-containment translation gets the most coverage.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerUserGroupStoreTests
{
    [Fact]
