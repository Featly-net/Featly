...
/// <summary>
/// Round-trips for <c>SqlServerRoleUpgradeRequestStore</c>, mirroring
/// <c>PostgresRoleUpgradeRequestStoreTests</c>. Status persists as its enum
/// name; the decision fields (decider, comment, decided-at) are nullable
/// until an admin acts.
/// </summary>
[Trait("Category", "RequiresSqlServer")]
public class SqlServerRoleUpgradeRequestStoreTests
{
    [Fact]
