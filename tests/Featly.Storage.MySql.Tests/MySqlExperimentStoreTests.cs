...
/// <c>SqlServerExperimentStoreTests</c>/<c>PostgresExperimentStoreTests</c>:
/// <c>MySqlExperimentStore</c> (with the MetricKeys JSON array and nullable
/// started/stopped window), the append-only <c>MySqlEventStore</c> (with a
/// JsonElement properties bag), and the first-write-wins
/// <c>MySqlAssignmentStore</c>.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlExperimentStoreTests
{
    [Fact]
