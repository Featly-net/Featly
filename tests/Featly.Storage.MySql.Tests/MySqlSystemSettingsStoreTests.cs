...
/// <summary>
/// Round-trips for <c>MySqlSystemSettingsStore</c>, mirroring
/// <c>SqlServerSystemSettingsStoreTests</c>/<c>PostgresSystemSettingsStoreTests</c>:
/// a typed-singleton row keyed by aggregate key, with a JSON payload and
/// audit stamps. Upsert is replace-in-place by key.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlSystemSettingsStoreTests
{
