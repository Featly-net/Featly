...
/// <summary>
/// Round-trips for <c>MySqlUserGroupStore</c>, mirroring
/// <c>SqlServerUserGroupStoreTests</c>/<c>PostgresUserGroupStoreTests</c>.
/// Membership is a plain JSON-column-backed scalar (see ADR-0033);
/// <c>ListForMemberAsync</c> is the lookup the permission checker uses to
/// expand a user into its groups, so the in-memory containment filter gets
/// the most coverage.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlUserGroupStoreTests
{
    [Fact]
