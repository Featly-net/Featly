...
/// <summary>
/// Round-trips for <c>MySqlUserStore</c>, mirroring <c>SqlServerUserStoreTests</c>/
/// <c>PostgresUserStoreTests</c>: create, update, disable, list, and the
/// uniqueness constraint on <see cref="User.Identifier"/>.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlUserStoreTests
{
    [Fact]
