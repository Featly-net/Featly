...
/// <summary>
/// Round-trips for <c>MySqlRoleAssignmentStore</c>, mirroring
/// <c>SqlServerRoleAssignmentStoreTests</c>/<c>PostgresRoleAssignmentStoreTests</c>.
/// Assignments are the polymorphic join (user/group → role) scoped to a
/// project and optionally an environment.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlRoleAssignmentStoreTests
{
    [Fact]
