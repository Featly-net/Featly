...
/// <summary>
/// Round-trips for <c>MySqlRoleUpgradeRequestStore</c>, mirroring
/// <c>SqlServerRoleUpgradeRequestStoreTests</c>/<c>PostgresRoleUpgradeRequestStoreTests</c>.
/// Status persists as its enum name; the decision fields (decider, comment,
/// decided-at) are nullable until an admin acts.
/// </summary>
[Trait("Category", "RequiresMySql")]
public class MySqlRoleUpgradeRequestStoreTests
{
    [Fact]
