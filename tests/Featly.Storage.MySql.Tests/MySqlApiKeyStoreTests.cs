...
/// <summary>
/// Persistence + lookup behaviour of <c>MySqlApiKeyStore</c>, mirroring
/// <c>SqlServerApiKeyStoreTests</c>/<c>PostgresApiKeyStoreTests</c>. The store
...
public class MySqlApiKeyStoreTests
{
    [Fact]
