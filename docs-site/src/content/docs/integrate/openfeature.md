---
title: OpenFeature
description: Adopt the vendor-neutral OpenFeature API and back it with Featly using the Featly.OpenFeature.Provider package.
---
...
options open tomorrow. OpenFeature is a [first-class, day-one feature](https://github.com/Featly-net/Featly/blob/main/docs/adr/0003-openfeature-first-class.md).
...
serves a flag read entirely through the OpenFeature client. Point it at a running
Featly server (the `SelfHosted.Sample` works) and hit
